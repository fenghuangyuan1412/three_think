    ...
    <div class="rulebook__card">
      ...
      <section>
        ...
        <ol class="rulebook__ol">
          ...
          <li>放置小弟 ⇄ 掷骰推船，交替进行 3 轮；每人都放完后可动领航员，再进行最后一段移动</li>
          <li>结算：货仓分利、港口 / 修船场赔付、保险理赔</li>
      ...
      <section>
        ...
        <ul class="rulebook__ul">
          ...
          <li><strong>海盗船</strong>：两格各付 ${PIRATE_SPACES.map((s) => s.cost).join('/')}。结算时若恰好有船停在第 13 格，海盗劫掠其货仓，利润归海盗格上的小弟平分，船上的小弟空手。</li>
          <li><strong>领航员</strong>：小领航员付 ${PILOT_SMALL_COST}（推/拉一艘船 1 格），大领航员付 ${PILOT_LARGE_COST}（推/拉 2 格或两艘各 1 格）。本身没有收益，用来把自家船推进港、或把别人推出第 13 格。</li>
